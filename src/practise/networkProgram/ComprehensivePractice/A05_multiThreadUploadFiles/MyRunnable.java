...
public class MyRunnable implements Runnable{
    ...
    public void run() {
        try {
            ...
            BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("src/practise/networkProgram/ComprehensivePractice/A05_multiThreadUploadFiles/" + randomName + ".txt"));
            int len;
