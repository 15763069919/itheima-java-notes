...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        //2.读取文件 写入服务器
        //使用字节流
        BufferedInputStream bis = new BufferedInputStream(new FileInputStream("src/practise/networkProgram/ComprehensivePractice/A05_multiThreadUploadFiles/a.txt"));
